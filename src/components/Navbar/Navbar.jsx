  ...
  return (
    <nav className="navbar">
      ...
      <ul className="nav-links">
        ...
        <li><Link to="/adoption">{t("navbar", "adoption")}</Link></li>
        <li><Link to="/lost-pets">{t("navbar", "lostPets")}</Link></li>
        <li><Link to="/success">{t("navbar", "successStories")}</Link></li>
        <li><Link to="/donations">{t("navbar", "donations")}</Link></li>
